BLT.Items.ColorTextBox = BLT.Items.ColorTextBox or class(BLT.Items.TextBox)
local ColorTextBox = BLT.Items.ColorTextBox
...
function BLT.Items.Menu:ColorTextBox(params)
    return self:NewItem(BLT.Items.ColorTextBox:new(self:ConfigureItem(params)))
end
