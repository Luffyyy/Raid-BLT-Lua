...
function decode_scanFunctionCall(s, nextPos)
  ...
  if not allowExpression and pePos < stringLen and decode_scanWhitespace(s, pePos) < stringLen then
    ...
    assert(nil,
      'Expressions are not allowed for function ' ..
      funcName .. ' at position ' .. nextPos - stringLen .. ' : ' .. nextPos)
  end
...
function isEncodable(o)
  ...
  return (t == 'string' or t == 'boolean' or t == 'number' or t == 'nil' or t == 'table' or specialFunctions[t] ~= nil) or
